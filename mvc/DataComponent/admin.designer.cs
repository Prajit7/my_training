...
namespace MVCApp.DataComponent
{
    ...
    partial void InsertticketAdmin(ticketAdmin instance);
    partial void UpdateticketAdmin(ticketAdmin instance);
    partial void DeleteticketAdmin(ticketAdmin instance);
    #endregion
		...
		public System.Data.Linq.Table<ticketAdmin> ticketAdmins
		{
			get
			{
				return this.GetTable<ticketAdmin>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ticketAdmin")]
	public partial class ticketAdmin : INotifyPropertyChanging, INotifyPropertyChanged
	{
