using SampleADOWeek3.Dalayer;
using SampleADOWeek3.Entities;
using System;
...
namespace SampleADOWeek3
{
    ...
    namespace Dalayer
    {
        ...
        class DataComponent : IDataAccessComponent
        {
            ...
            const string STRUPDATE = "Update tblEmployee Set EMPNAME = @empName, EMPADDRESS = @empAddress, EMPSALARY = @empSalary,DEPTID=@deptId,MGRID=@mgrId WHERE EMPID = @empId";
            ...
            public void AddNewEmployee(Employee emp)
            {
                ...
                parameters.Add(new SqlParameter("@mgrId", emp.MgrId));
