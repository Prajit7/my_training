<%@ Page Title="" Language="C#" MasterPageFile="~/MasterSheet.Master" AutoEventWireup="true" CodeBehind="validation.aspx.cs" Inherits="SampleWebApp.validation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-8">
                <h1 class="h1">Employee Validation Page</h1>
                <hr />
                <div>
                   <p>
                ...
                <asp:CustomValidator  ID="CustomValidator1" runat="server" ControlToValidate="txtName" ErrorMessage="Name should be either Trainer or Trainee" ForeColor="#FF3300" OnServerValidate="CustomValidator1_ServerValidate" ClientValidationFunction="customValidation"></asp:CustomValidator>
                   ...
                   <p>
                       ...
                       <asp:regularexpressionvalidator runat="server" errormessage="Email is not in a proper format" ForeColor="red"  ControlToValidate="txtEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:regularexpressionvalidator>
                   </p>
                    <p>
                          <p>
                Enter the Password:
                ...
                <asp:comparevalidator runat="server" errormessage="Password Mismatch" ControlToCompare="txtPwd" ControlToValidate="txtRetype" ForeColor="#FF3300"></asp:comparevalidator>
                    ...
                    <<p>
                        ...
                        <asp:TextBox runat="server" TextMode="Number" ID="txtExp"/>
                             <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Exp should between 3 to 10 years." ControlToValidate="txtExp" MaximumValue="10" MinimumValue="3"></asp:RangeValidator>
                    </p>
                    <p>
                Enter the years of Experience:
